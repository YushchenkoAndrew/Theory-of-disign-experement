...
public class Experiment {
    ...
    private boolean checking() {
        ...
        System.out.printf("Gt = %5.3f\n\n", math.koharenaMeasure(m - 1, f2));

        if ((maxDispersion / totalDispersion) > math.koharenaMeasure(m - 1, f2)) {
            m++;
